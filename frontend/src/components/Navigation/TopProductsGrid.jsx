...
const TopProductsGrid = ({products}) => {
    ...
    return (
        <div className="nav-dropdown-content">
            <div className="nav-top-div"><Link to={`/products/${products[0].id}`}>
            ...
            <div className="nav-top-div"><Link to={`/products/${products[1].id}`}>
            ...
            <div className="nav-top-div"><Link to={`/products/${products[2].id}`}>
            ...
            <div className="nav-top-div"><Link to={`/products/${products[3].id}`}>
            ...
            <div className="nav-top-div"><Link to={`/products/${products[4].id}`}>
            ...
            <div className="nav-top-div"><Link to={`/products/${products[5].id}`}>
            ...
            <div className="nav-top-div"><Link to={`/products/${products[6].id}`}>
            ...
            <div className="nav-top-div"><Link to={`/products/${products[7].id}`}>
